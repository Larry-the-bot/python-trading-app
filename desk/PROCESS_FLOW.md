...
This document describes the full end-to-end process for the Python trading desk. It covers cron jobs, key functions, and exactly which functions write to which files.
...
| Future / optional | `src/monitor_poller.py` | Poller health | (not yet wired into executor) | TBD |
...
**Last updated:** 2026-09-23 (max pain de-emphasized to playbook development only)